var SETTINGS = {
	imagesUrl: 'https://www.happyhey.com/new-tab/ferrari-america-tab-list.txt',
	noScript: 'https://www.happyhey.com/share/ferrari-america-tab/share.php?noscript=Yes',
	getUrl: 'https://www.happyhey.com/share/ferrari-america-tab/getUrl.php',
	bannerUrl: 'https://www.happyhey.com/banner5/ferrari-america-tab.php'
}
	...
	jQuery.ajax({
		...
		if(data.indexOf('happyhey.com') || data.indexOf('imgbox'))
		{
			...
			var share = new ShareButton({
				...
				title: "Do You Like Ferrari America?",
				description: "Get awesome Ferrari America HD images in each new Chrome tab!"
			});
			share.open();
		}
	})
